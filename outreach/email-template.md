# Outreach e-mailtemplate — subsidie-oriëntatie

Afzender: vovara@uprisingstudio.nl
Doel: kennismaken met het fonds, toetsen of het profiel past bij de regeling, en vragen naar de beste route voor een eerste aanvraag.

> Let op: dit is de basistemplate. Per fonds wordt de e-mail gepersonaliseerd
> (naam regeling, specifieke vraag). Velden tussen [blokhaken] vul je zelf in
> vóór verzending.

---

**Onderwerp:** Oriëntatievraag [naam regeling] — onafhankelijk artiest uit Amersfoort
...
Ik hoor graag van u. Alvast hartelijk dank voor uw tijd.
